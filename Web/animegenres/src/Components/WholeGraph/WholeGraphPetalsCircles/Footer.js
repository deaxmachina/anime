  ...
  return (
    <div className="whole-graph-petalscircles-footer">  
      ...
      <ul className="whole-graph-petalscircles-methodology-list">
        <li>
          For each anime, each anime is displayed once, even if it ran over multiple seasons. For long-running anime that means they end up being put in the winter season as it is the first of the year.
        </li>
        <li>
          The colouring of the genres is based on a completely subjective ordering of "seriousness" of the genre, aiming to give a visual representation of what kind of anime are most popular. 
        </li>
        <li>
